...
from sqlalchemy import Column , Integer , String , Text , DateTime , func , Date , ForeignKey , UUID
...
class ToDo(Base):
    ...
    def is_overdue(self) -> bool:
        ...
        if self.status != ToDoStatus.completed and self.due_date and self.due_date < datetime.now().date():
            return True
        return False
